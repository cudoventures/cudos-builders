...
```
git clone --branch v0.6.0 https://github.com/CudoVentures/cudos-node.git CudosNode
git clone --branch v0.6.0  https://github.com/CudoVentures/cudos-builders.git CudosBuilders
git clone --branch v0.6.0 https://github.com/CudoVentures/cosmos-gravity-bridge.git CudosGravityBridge
```
