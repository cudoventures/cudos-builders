...
if [ "$CUDOS_TOKEN_CONTRACT_ADDRESS" = "0xE92f6A5b005B8f98F30313463Ada5cb35500a919" ] || "$CUDOS_TOKEN_CONTRACT_ADDRESS" = "0x28ea52f3ee46CaC5a72f72e8B3A387C0291d586d" ] || [ "$CUDOS_TOKEN_CONTRACT_ADDRESS" = "0x12d474723cb8c02bcbf46cd335a3bb4c75e9de44" ]; then
